...
<div id="c5e3c80f-81ac-49f7-82af-2aaadd575ec4" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c5e3c80f81ac49f782af2aaadd575ec4 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('c5e3c80f-81ac-49f7-82af-2aaadd575ec4', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_c5e3c80f81ac49f782af2aaadd575ec4();
                };
...
<div id="63b09694-6140-419a-ae8c-144530f17b4b" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_63b096946140419aae8c144530f17b4b = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('63b09694-6140-419a-ae8c-144530f17b4b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_63b096946140419aae8c144530f17b4b();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
