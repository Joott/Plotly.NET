...
<div id="1cf6fc5c-1630-4af8-8444-832a8e7d9b5c" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_1cf6fc5c16304af88444832a8e7d9b5c = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('1cf6fc5c-1630-4af8-8444-832a8e7d9b5c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_1cf6fc5c16304af88444832a8e7d9b5c();
                };
...
<div id="622da225-c3fd-4aa4-b51d-dca7597f7655" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_622da225c3fd4aa4b51ddca7597f7655 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('622da225-c3fd-4aa4-b51d-dca7597f7655', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_622da225c3fd4aa4b51ddca7597f7655();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
