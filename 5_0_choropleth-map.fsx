...
<div id="24246784-0856-495c-aecb-a41c04ee7e77" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_242467840856495caecba41c04ee7e77 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('24246784-0856-495c-aecb-a41c04ee7e77', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_242467840856495caecba41c04ee7e77();
                };
...
<div id="f20dabab-ca59-4294-b9b5-c0a40004466e" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f20dababca594294b9b5c0a40004466e = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('f20dabab-ca59-4294-b9b5-c0a40004466e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_f20dababca594294b9b5c0a40004466e();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
