...
<div id="7fbc4fcd-be1c-4c46-b96c-e6dad3c07256" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_7fbc4fcdbe1c4c46b96ce6dad3c07256 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('7fbc4fcd-be1c-4c46-b96c-e6dad3c07256', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_7fbc4fcdbe1c4c46b96ce6dad3c07256();
                };
...
<div id="fbeacbdc-06d6-4d47-ae01-6a41faa1eb31" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_fbeacbdc06d64d47ae016a41faa1eb31 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('fbeacbdc-06d6-4d47-ae01-6a41faa1eb31', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_fbeacbdc06d64d47ae016a41faa1eb31();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
