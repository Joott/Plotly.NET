...
<div id="9bcb01b5-be67-4147-b5ce-3468fbd1a510" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_9bcb01b5be674147b5ce3468fbd1a510 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('9bcb01b5-be67-4147-b5ce-3468fbd1a510', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_9bcb01b5be674147b5ce3468fbd1a510();
                };
...
<div id="a7abf44c-5bb5-4f6e-8ed4-eccff9cd7111" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a7abf44c5bb54f6e8ed4eccff9cd7111 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('a7abf44c-5bb5-4f6e-8ed4-eccff9cd7111', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_a7abf44c5bb54f6e8ed4eccff9cd7111();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<div id="4a6f0736-95b1-431f-a46d-a48c5124fccf" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4a6f073695b1431fa46da48c5124fccf = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('4a6f0736-95b1-431f-a46d-a48c5124fccf', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_4a6f073695b1431fa46da48c5124fccf();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
