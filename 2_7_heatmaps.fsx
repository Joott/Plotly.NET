...
<div id="a091528f-b0ba-448e-81c3-579d4b03b3a4" style="width: 700px; height: 500px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a091528fb0ba448e81c3579d4b03b3a4 = function() {
            ...
            var config = {};
            Plotly.newPlot('a091528f-b0ba-448e-81c3-579d4b03b3a4', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_a091528fb0ba448e81c3579d4b03b3a4();
                };
...
<div id="5765a548-c583-4f03-aa4c-a04709ba072a" style="width: 700px; height: 500px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_5765a548c5834f03aa4ca04709ba072a = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {"width":700.0,"height":500.0,"margin":{"l":200.0}};
            var config = {};
            Plotly.newPlot('5765a548-c583-4f03-aa4c-a04709ba072a', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_5765a548c5834f03aa4ca04709ba072a();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
