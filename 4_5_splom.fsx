...
<div id="d39c36fd-b490-49a9-a687-997250dff5f3" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d39c36fdb49049a9a687997250dff5f3 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('d39c36fd-b490-49a9-a687-997250dff5f3', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d39c36fdb49049a9a687997250dff5f3();
                };
