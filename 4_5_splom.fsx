...
<div id="73b62b79-6532-48fc-a6bc-899a534a6886" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_73b62b79653248fca6bc899a534a6886 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('73b62b79-6532-48fc-a6bc-899a534a6886', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_73b62b79653248fca6bc899a534a6886();
                };
