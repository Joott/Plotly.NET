...
<div id="7fe36572-977f-42e2-9154-3019700fa706" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_7fe36572977f42e291543019700fa706 = function() {
            ...
            var config = {};
            Plotly.newPlot('7fe36572-977f-42e2-9154-3019700fa706', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_7fe36572977f42e291543019700fa706();
                };
