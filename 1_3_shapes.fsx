...
<div id="719c86e4-3009-4661-9ac5-350c5d998365" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_719c86e4300946619ac5350c5d998365 = function() {
            ...
            var config = {};
            Plotly.newPlot('719c86e4-3009-4661-9ac5-350c5d998365', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_719c86e4300946619ac5350c5d998365();
                };
