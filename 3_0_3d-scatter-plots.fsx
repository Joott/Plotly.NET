...
<div id="d565172d-4038-41c1-9396-a3552e71148f" style="width: 800px; height: 800px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d565172d403841c19396a3552e71148f = function() {
            ...
            var config = {};
            Plotly.newPlot('d565172d-4038-41c1-9396-a3552e71148f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d565172d403841c19396a3552e71148f();
                };
