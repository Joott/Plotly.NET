...
<div id="6892b6e0-48ae-4600-85d2-0478676ebd74" style="width: 800px; height: 800px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_6892b6e048ae460085d20478676ebd74 = function() {
            ...
            var config = {};
            Plotly.newPlot('6892b6e0-48ae-4600-85d2-0478676ebd74', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_6892b6e048ae460085d20478676ebd74();
                };
