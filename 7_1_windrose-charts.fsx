...
<div id="096df097-9bd2-48c5-b0c9-8eda7340b2ef" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_096df0979bd248c5b0c98eda7340b2ef = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('096df097-9bd2-48c5-b0c9-8eda7340b2ef', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_096df0979bd248c5b0c98eda7340b2ef();
                };
