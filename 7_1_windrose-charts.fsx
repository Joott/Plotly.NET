...
<div id="976b41ca-1630-4f49-8239-43c29408d8e6" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_976b41ca16304f49823943c29408d8e6 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('976b41ca-1630-4f49-8239-43c29408d8e6', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_976b41ca16304f49823943c29408d8e6();
                };
