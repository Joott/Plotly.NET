...
<div id="d44ee201-0cb9-4814-ab68-58046ce37116" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d44ee2010cb94814ab6858046ce37116 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('d44ee201-0cb9-4814-ab68-58046ce37116', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d44ee2010cb94814ab6858046ce37116();
                };
