...
<div id="8802455b-4b0d-4b60-8447-c5bae9e60e7b" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_8802455b4b0d4b608447c5bae9e60e7b = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('8802455b-4b0d-4b60-8447-c5bae9e60e7b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_8802455b4b0d4b608447c5bae9e60e7b();
                };
