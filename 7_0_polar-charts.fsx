...
<div id="f48b95a1-c82f-4161-b049-6166cf49108e" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f48b95a1c82f4161b0496166cf49108e = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('f48b95a1-c82f-4161-b049-6166cf49108e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f48b95a1c82f4161b0496166cf49108e();
                };
