...
<div id="8057d128-7d73-40cc-89a2-1114a0f8c191" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_8057d1287d7340cc89a21114a0f8c191 = function() {
            ...
            var layout = {};
            var config = {};
            Plotly.newPlot('8057d128-7d73-40cc-89a2-1114a0f8c191', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_8057d1287d7340cc89a21114a0f8c191();
                };
...
<div id="c5e4bfcf-b859-4a16-be2f-0b025af31c68" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c5e4bfcfb8594a16be2f0b025af31c68 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('c5e4bfcf-b859-4a16-be2f-0b025af31c68', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_c5e4bfcfb8594a16be2f0b025af31c68();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
